<!-- http://localhost:4000/auto_auth?autoRegister=true&autoSetup=true&first_name=John&last_name=Doe&email=existing@example.com&password=ExistingPass123&org_name=Test%20Company&org_location=US -->
...
git clone https://github.com/KadMap-Dev-Proj/kadmap-accounting
cd kadmap-accounting
...
Note* url format:
{BASE_URL}/auto_auth?autoRegister=true&autoSetup=true&first_name=John&last_name=Doe&email=existing@example.com&password=ExistingPass123&org_name=Test%20Company&org_location=US
